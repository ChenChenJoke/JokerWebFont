...
圆圈动画加载是很酷的效果，以前只有flash或者是gif图片可以制作，不过现在有了css3这种新的技术，加上html5的svg绘画，这种效果已经司空见惯了，今天给大家分享一个制作CSS3圆圈饼图loading加载动画的教程。
...
/*
 * Some bugs with Chrome (Android), Safari and Opera, I'll try to see how  made his code.
 */
...
> 项目地址 ： http://codepen.io/CreativeJuiz/pen/vFBIh